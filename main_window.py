...
class PrintOptionsDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.ed_template = QtWidgets.QLineEdit(os.path.abspath("images/nn_preprint_blank.png"))
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def print_clicked(self):
        ...
        template_path = self.settings.value("print/template_path", "images/nn_preprint_blank.png")
        if not os.path.exists(template_path):
            template_path = "images/nn_preprint_blank.png"
